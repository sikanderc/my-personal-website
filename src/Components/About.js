  ...
  render() {
    return (
      <div className="About section">
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/VzQNdk2BYkQ?controls=0&amp;start=41" frameborder="0" allowfullscreen></iframe>
      </div>
    );
  }
}
