...
import petinder from '../Images/petinder.gif'
import puertosupport from '../Images/puertosupport.gif'
import ds3 from '../Images/ds3.gif'
import MACportal from '../Images/MACportal.gif'
        ...
        <a className="macBox" >
          <div className="row align-items-center featured" >
            <div className="col-md-5 offset-md-1 featured-body mt-sm-0" >
              ...
              <img src={MACportal} className="img-fluid" alt="MAC" />
              </div>
              ...
              <p><a href="https://github.com/sikanderc/mac-volunteer-portal" target="_blank" rel="noopener noreferrer">GitHub Repository - Frontend<i className="fa fa-github" aria-hidden="true"/></a></p>
              <p><a href="https://github.com/sikanderc/mac-volunteer-portal-api" target="_blank" rel="noopener noreferrer">GitHub Repository - Backend<i className="fa fa-github" aria-hidden="true"/></a></p>
        ...
        <a className="ds3Box" >
          <div className="row align-items-center featured" >
            <div className="col-md-5 offset-md-1 featured-body mt-sm-0" >
              ...
              <div className="col-md-5" >
              <img src={ds3} className="img-fluid" alt="DS3" />
              </div>
              ...
              <p><a href="https://github.com/mattgellert/downhill-skiing-snowman-slayer-front-end" target="_blank" rel="noopener noreferrer">GitHub Repository - Frontend<i className="fa fa-github" aria-hidden="true"/></a></p>
              <p><a href="http://mattgellert/downhill-skiing-snowman-slayer-back-end" target="_blank" rel="noopener noreferrer">GitHub Repository - Backend<i className="fa fa-github" aria-hidden="true"/></a></p>
        ...
        <a className="peTinderBox" >
          <div className="row align-items-center featured" >
            <div className="col-md-5 offset-md-1 featured-body mt-sm-0" >
              ...
              <div className="col-md-5" >
              <img src={petinder} className="img-fluid" alt="PeTinder" />
              </div>
              ...
              <p><a href="https://github.com/sikanderc/petinder-cli-ruby" target="_blank" rel="noopener noreferrer">GitHub Repository<i className="fa fa-github" aria-hidden="true"/></a></p>
