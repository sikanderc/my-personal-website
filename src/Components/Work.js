        ...
        <div className="macBox" >
          <div className="section" >
            <div >
              ...
              <p className="macInfo3">Also, I was tasked with developing new projects for the organization to take on, maintaining the social media accounts, overseeing the continued development of the website, keeping track of the accounts, networking with leaders across the Compassionate Louisville community, and periodically communicating with the press.</p>
        ...
        <div className="halalarBox" >
          <div className="section" >
            <div >
              ...
              <br/>
              <p className="halalarInfo" >My close friend, Samad Jawaid, a veteran software engineer, and I decided to create a Muslim Matrimony mobile application, called Halalar. It was the first of it's kind.</p>
              <p className="halalarInfo2">We bootstrapped the firm from napkin-stage to production app in less than a year. Unfortunately, after some time operating, we were forced to shut down shop due to unforseen legal circumstances. Overall, it was a wonderful learning experience.</p>
